...
/**
 * Modal for viewing, renaming, deleting, and overwriting user profiles. Shows a
 * ProfileComparison preview before overwriting. Uses manual touch-to-scroll inside the modal.
...
const ProfileManagerModal: React.FC<ProfileManagerModalProps> = ({
    ...
    /** Manual touch-to-scroll mechanism, same pattern as MultiSelector.tsx. */
    ...
    const styles = useMemo(
        () =>
            StyleSheet.create({
                ...
                // maxHeight 80% + flexShrink keep the modal on screen as content grows.
                modalContent: {
                ...
                // flexShrink lets the ScrollView fill remaining space and scroll past modalContent maxHeight.
                // Scrolling itself is driven by the manual touch handlers above.
                mainScroll: {
                    flexShrink: 1,
                },
                mainScrollContent: {
            ...
            <RNModal visible={visible && !showDeleteDialog} transparent={true} animationType="fade" onRequestClose={onClose}>
                <TouchableOpacity style={styles.modal} activeOpacity={1} onPress={onClose}>
                    <TouchableOpacity style={styles.modalContent} activeOpacity={1} onPress={(e) => e.stopPropagation()}>
                        ...
                        {/* Manual touch handlers: native ScrollView events get swallowed by the RNModal / overlays here. */}
                        <ScrollView
