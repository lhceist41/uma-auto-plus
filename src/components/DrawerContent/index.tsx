...
/**
 * Drawer sidebar with multi-level expand/collapse menus, active-route highlighting,
 * and deferred navigation for smooth drawer animations.
...
const DrawerContent: React.FC<DrawerContentComponentProps> = (props) => {
    ...
    const handleNavigation = (routeName: string) => {
        ...
        // Close first so the close animation hides the target page's mount lag.
        navigation.closeDrawer()

        // Defer the navigation so the target's mount/render doesn't stutter the close animation.
        setTimeout(() => {
            if (routeName === "Home") {
