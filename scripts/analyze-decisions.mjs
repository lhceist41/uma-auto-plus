...
import { createDecisionAnalyzer, renderReport } from "../src/lib/decisionAnalysis.ts"
...
function parseArgs(argv) {
    const opts = { decisions: null, careers: null, careerToken: undefined, since: undefined, fromLine: undefined, strict: false, json: false, help: false }
